...
class chip_password_generator {
  ...
  */
  ...
  private $alpha_upper = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'J', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z'];
  private $alpha_lower = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'm', 'n', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z'];
  private $number = [1, 2, 3, 4, 5, 6, 7, 8, 9];
  private $symbol = ['-', '_', '^', '~', '@', '&', '|', '=', '+', ';', '!', ',', '(', ')', '{', '}', '[', ']', '.', '?', '%', '*', '#'];
  private $input = 4;
  ...
  */
  ...
  private function chip_parse_args( $args = [], $defaults = [] ) {
